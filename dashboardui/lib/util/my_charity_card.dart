    ...
    Widget build(BuildContext context) {
        return StreamBuilder(
            ...
            builder: (context, userSnapshot) {
                return StreamBuilder(
                    stream: FirebaseFirestore.instance.collection('charities').doc(charityId).snapshots(),
                                        ...
                                        children:[
                                            ...
                                            Row(
                                                ...
                                                children:[
                                                    ...
                                                    ElevatedButton(
                                                        onPressed: () {
                                                            var charityDict = userSnapshot.data!['charitySelection'];
                                                            charityDict[charityId] = _currentSliderValue;
