            ...
            child: Column(children: [
                        ...
                        Text(
                          ...
                          style: TextStyle(
                            fontSize: getFontSize(
                                0.08, heightOfDevice, widthOfDevice),
              ...
              Padding(
                padding: EdgeInsets.only(
                    left: 0.1 * widthOfDevice,
                    right: 0.1 * widthOfDevice,
                    top: heightOfDevice * 0.02),
                child: Container(
                    width: widthOfDevice * 0.8,
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(
                          ...
                          style: TextStyle(
                            fontSize: getFontSize(
                                0.045, heightOfDevice, widthOfDevice),
                            color: Color(0xFF003049),
                          ),
                        ),
                      ],
              ...
              Container(
                  ...
                  child: ListView.builder(
                    itemCount:
                        userDoc!.donationMethods!['donationPreferences'] != null
                            ? userDoc!
                                .donationMethods!['donationPreferences'].length
                            : 0,
