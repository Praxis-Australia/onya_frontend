          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                Container(
                  ...
                  children:[
                    ...
                    Text(
                      ...
                      style:
                          TextStyle(fontSize: getFontSize(0.05, heightOfDevice, widthOfDevice), color: Color(0xFF3D405B), fontWeight: FontWeight.bold),
                    ),
                    ...
                    Row(
                      ...
                      children: [
                        Text(
                          'I want to donate to ',
                          style:
                              TextStyle(fontSize: getFontSize(0.04, heightOfDevice, widthOfDevice), color: Color(0xFF3D405B)),
                        ),
                        SizedBox(width: 8.0),
                        ConstrainedBox(
                          constraints: BoxConstraints(maxWidth: 0.4 * widthOfDevice, maxHeight: 0.1 * heightOfDevice),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        SizedBox(width: 8.0),
                        ConstrainedBox(
                          constraints: BoxConstraints(maxWidth: 0.6 * widthOfDevice, maxHeight: 0.1 * heightOfDevice),
                          child: DropdownButtonFormField<String>(
                            decoration: InputDecoration(
                              focusedBorder: OutlineInputBorder(
                                borderSide: BorderSide(
                ...
                Container(
                  height: 0.5*heightOfDevice,
                  width: 0.8*widthOfDevice,
                              ...
                              ? Column(
                                  children: [
                                    Center(child:Text(
                                      ...
                                      style: TextStyle(
                                        fontSize: getFontSize(0.04, heightOfDevice, widthOfDevice),
                                    ...
                                    Text(
                                      ...
                                      style: TextStyle(
                                        fontSize: getFontSize(0.03, heightOfDevice, widthOfDevice),
                                        color: Color(0xFF3D405B),
                                      ),
